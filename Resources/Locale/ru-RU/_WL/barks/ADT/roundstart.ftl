...
bark-mooch-name = Муч (Undertale Yellow)
...
bark-stats-name = Статистика (Undertale)
bark-default-name = Стандартный (Undertale)
bark-oneshot-name = Текст (OneShot)
bark-angryflowey-name = Злой Флауи (Undertale)
bark-oneshot-robot-name = Робот (OneShot)
bark-fatalerror-sans-name = Fatal Error Санс
