...
doc-text-printer-order-dismissal =
    ...
    Я, :ФИО:, :ДОЛЖНОСТЬ:, приказываю отстранить от работы сотрудника :ФИО:, отдела :наименование отдела:, занимающего должность :полное наименование должности:, до прибытия на ЦК по причине: :указать причину:.
