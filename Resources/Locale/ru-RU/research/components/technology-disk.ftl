...
tech-disk-examine-desc = [color=lightGray]Диск для сервера НИО, содержащий технологию [bold]{ $tier } уровня[/bold] для ветки технологий [bold]{ $branch }.[/bold][/color]
tech-disk-examine-desc-unknown = [color=lightGray]Диск для сервера НИО, содержащий технологию.[/color]
