...
ent-ShippingContainerStellarcorp = грузовой контейнер Конгломерата
    .desc = Контейнер стандартного размера для транспортировки больших объёмов грузов. Этот контейнер принадлежит Звёздному Корпоративному Конгломерату, крупнейшему объединению транс-звёздных корпораций, действующий в интересах бизнеса и монополии, производящий можество различных товаров.
