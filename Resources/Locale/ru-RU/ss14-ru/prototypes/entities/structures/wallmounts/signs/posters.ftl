...
ent-PosterContrabandCybersun600 = Cybersun: 100-ый юбилей компании
    .desc = Художественный плакат, посвящённый 100-летию успешной деятельности компании Cybersun Industries.
...
ent-PosterLegit50thAnniversaryVintageReprint = Винтажная перепечатка к 50-летнему юбилею
    .desc = Перепечатка плаката 2170 года, посвящённого 50-летию компании Nanoposters Manufacturing, дочерней компании Nanotrasen.
