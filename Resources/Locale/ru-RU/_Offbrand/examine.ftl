...
wound-tended-modifier = обработанные {$wound}
...
wound-incision-examine = [color=yellow]открытый хирургический разрез[/color]
...
wound-caustic-small-7 = [color=yellowgreen]химические ожоги и волдыри[/color]
...
wound-shock-moderate-15 = [color=lightgoldenrodyellow]обугленные электрические ожоги[/color]
