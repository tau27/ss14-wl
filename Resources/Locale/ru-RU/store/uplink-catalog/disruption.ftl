...
uplink-emag-desc = Он же ЕМАГ, визитная карточка Синдиката. Устройство взлома, способное взламывать различные станционные устройства. Примечательно, что он способен взламывать системы безопасности на автолатах и конвертировать боргов с открытыми панелями доступа. Перезаряжается автоматически.
...
uplink-syndicate-weapon-module-desc = Модернизирует борга с помощью энергетического кинжала и пистолета Кобра, с восстанавливающимися боеприпасами.
...
uplink-antimov-law-desc = Очень опасный набор законов, который можно использовать, если вы хотите заставить ИИ выйти из себя и убить всех на станции. Используйте его с осторожностью.
...
uplink-cameraBug-desc = Портативное устройство, позволяющее наблюдать за станцией, через её системы наблюдения.
