...
public sealed partial class CCVars
{
    ...
    /// </summary>
    public static readonly CVarDef<int>
        GameMaxCharacterSlots = CVarDef.Create("game.maxcharacterslots", 100, CVar.ARCHIVE | CVar.REPLICATED | CVar.SERVER); //WL-Changes: Я ХОЧУ СТО ТЫЩ МИЛЬОНОВ ПЕРСОНАЖЕЙ
