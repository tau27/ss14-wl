    ...
    private void AddTricksVerbs(GetVerbsEvent<Verb> args)
    {
        ...
        if (activeId is not null)
        {
            Verb grantAllAccess = new()
            {
                ...
                Category = VerbCategory.Tricks,
                Icon = new SpriteSpecifier.Rsi(new("/Textures/_WL/Objects/Misc/id_cards.rsi"), "centcom"), // WL-Changes: resprite
                Act = () =>
                {
            ...
            Verb revokeAllAccess = new()
            {
                ...
                Category = VerbCategory.Tricks,
                Icon = new SpriteSpecifier.Rsi(new("/Textures/_WL/Objects/Misc/id_cards.rsi"), "default"), // WL-Changes: resprite
                Act = () =>
                {
