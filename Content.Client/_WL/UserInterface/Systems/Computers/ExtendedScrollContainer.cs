...
/// <summary>
/// Extended copy of <see cref="ScrollContainer" />
/// </summary>
[Virtual]
public class ExtendedScrollContainer : Container
{
    ...
    {
        get => VScrollBar.ValueTarget;
        set => VScrollBar.ValueTarget = value;
    }
    ...
    {
        get => HScrollBar.ValueTarget;
        set => HScrollBar.ValueTarget = value;
    }
    ...
    public ExtendedScrollContainer()
    {
