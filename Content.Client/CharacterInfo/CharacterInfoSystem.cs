...
public sealed partial class CharacterInfoSystem : EntitySystem
{
    ...
    private void OnCharacterInfoEvent(CharacterInfoEvent msg, EntitySessionEventArgs args)
    {
        ...
        var data = new CharacterData(entity, msg.Objectives, msg.Briefing, msg.Job, Name(entity)/*WL: End*/, msg.JobName/*WL: Start*/); // WL-Changes: Subnames
    ...
    public readonly record struct CharacterData(
        ...
        string EntityName,
        string? JobName // WL-Changes: Subnames
    );
